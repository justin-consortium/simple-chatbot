...
const PROFILES: PreviewProfile[] = [
  ...
  {
    label: 'Dolores — TBI, parent (caring for her adult child) — FIRST session',
    mode: 'free', firstSession: true,
    careRecipientCondition: 'TBI',
    displayName: 'Dolores',
    tone: '',
    coping: [{ approach: 'quiet and rest', effect: '' }],
    caregivingSituation: 'Caring for their child, for 2 years. Their caregiving includes: personal care, healthcare coordination, financial management.',
    threads: [],
  },
  {
    label: 'Frank — TBI, grandparent (caring for his grandchild) — FIRST session',
    mode: 'free', firstSession: true,
    careRecipientCondition: 'TBI',
    displayName: 'Frank',
    tone: 'direct and to the point, going easy on hedging',
    coping: [{ approach: 'connecting with others', effect: '' }],
    caregivingSituation: 'Caring for their grandchild, for 1 year. Their caregiving includes: supervision, transportation.',
    threads: [],
  },
  {
